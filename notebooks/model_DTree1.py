...
accidents = pd.read_csv('data/created/timeseries/ts_counts_by_date.csv')
...
#----------------
# MODEL
dtree = DecisionTreeClassifier(criterion="gini", ccp_alpha=0.00217087,
                               max_depth=4, splitter='best', random_state=2)
...
sns.barplot(y=imp_feat, x=importances, orient='h')
